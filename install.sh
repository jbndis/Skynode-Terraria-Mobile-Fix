...
DOWNLOAD_LINK=https://github.com/jbndis/Skynode-Terraria-Mobile-Fix/raw/main/ServerLinux.zip
...
curl -sSL https://github.com/jbndis/Skynode-Terraria-Mobile-Fix/raw/main/ServerLinux.zip -o ${DOWNLOAD_LINK##*/}
